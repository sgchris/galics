...
<head>
    ...
    <style>
    .card-folder,.card-folder:hover{text-decoration:none;color:initial}.card-folder,.preview-thumb-wrapper{float:left;margin:0 .5rem .5rem 0;box-sizing:border-box}body{background:#EEE}.main-wrapper{padding-top:1rem;padding-bottom:1rem}.card-folder{padding:.5rem;width:14.5rem;height:16rem;xbackground:#FFF0BF;xbox-shadow:0 0 5px rgba(0,0,0,.3)}.card-file,.card.card-file{xbackground:#FFF}.card-folder .card-title{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.card-folder .card-body{padding:0}.card-folder .card-body-main-image-wrapper{text-align:center;line-height:15rem;max-height:100%;max-width:100%;overflow:hidden}.preview-thumb-wrapper{width:6rem;height:6rem;text-align:center;line-height:100px;padding:.2rem;xborder:1px solid #CCC;xbackground:#EEE}.preview-thumb-wrapper i{font-size:4rem;vertical-align:middle}.preview-thumb-wrapper img,.preview-thumb-wrapper video{max-width:100%;max-height:100%;margin:0;padding:0;vertical-align:top;border-radius:2px;xbackground:#EEE}.preview-thumb-wrapper video{background:#333}.card-folder .main-image{max-width:100%;max-height:100%;background:#EEE;padding:2px}.card-folder video.main-image{background:#333}
    </style>
    <!--
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    if (count(glob($folder.'/*', GLOB_ONLYDIR)) > 0) {
                        $itemsInFolder++;
                        ?><div class="preview-thumb-wrapper" itemsInFolder="<?php echo $itemsInFolder; ?>"><i class="far fa-folder"></i></div><?php
                    }
